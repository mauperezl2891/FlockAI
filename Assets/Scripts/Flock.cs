...
public class Flock : MonoBehaviour
{
    ...
    [Header("Spawn Setup")]
    [SerializeField] private FlockUnits flockUnitPrefab;
    ...
    [Range(0, 100)]
    [SerializeField] private float _obstacleAvoidanceWeight;

    public float obstacleAvoidanceWeight { get { return _obstacleAvoidanceWeight; } }

    public FlockUnits[] allUnits { get; set; }
    ...
    private void Update()
    {
        ...
        {
            allUnits[i].MoveUnits();
        }
    }

    private void GenerateUnits()
    {
        allUnits = new FlockUnits[flockSize];
